...
// Syntax
//   [ THETA ] = sTBP( WD , phi , N , ALPHA , BETA , SEED , OUTPUT )


void sTBP(double ALPHA, double BETA, int W, int J, int D, int NN, int OUTPUT, mwIndex *jc, mwIndex *ir, double *sr,
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) 
{
	...
	sTBP(ALPHA, BETA, W, J, D, NN, OUTPUT, jc, ir, sr, phi, theta);
