...
// Syntax
//   [ PHI , THETA , MU ] = ssiBP( WD , J , N , ALPHA , BETA , SEED , OUTPUT )

// Syntax
//   [ PHI , THETA , MU ] = ssiBP( WD , J , N , ALPHA , BETA , SEED , OUTPUT , MUIN )


void ssiBP(double ALPHA, double BETA, int W, int J, int D, int NN, int OUTPUT, double *sr, mwIndex *ir, mwIndex *jc,
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) 
{
	...
	ssiBP(ALPHA, BETA, W, J, D, NN, OUTPUT, sr, ir, jc, phi, theta, mu, startcond);
