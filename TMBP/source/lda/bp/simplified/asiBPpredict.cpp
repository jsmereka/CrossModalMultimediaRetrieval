...
// Syntax
//   [ THETA , MU ] = asiBP( WD , phi , N , ALPHA , BETA , SEED , OUTPUT )

// Syntax
//   [ THETA , Mu ] = asiBP( WD , phi , N , ALPHA , BETA , SEED , OUTPUT , MUIN )


void asiBP(double ALPHA, double BETA, int W, int J, int D, int NN, int OUTPUT, mwIndex *jc, mwIndex *ir, double *sr,
