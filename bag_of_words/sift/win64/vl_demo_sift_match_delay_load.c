 ...
 */
FARPROC WINAPI vl_demo_sift_matchDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = vl_demo_sift_matchDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = vl_demo_sift_matchDelayLoadWin32FailureHook;
#endif
