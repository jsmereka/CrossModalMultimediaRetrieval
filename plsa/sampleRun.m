...
% mex mex_Pw_d.c -largeArrayDims
% mex mex_EMstep.c -largeArrayDims
% mex mex_logL.c -largeArrayDims
...
% start pLSA
[Pw_z,Pz_d,Pd,Li,perp,beta] = pLSA(Xtrain,[],k,Learn);

% fold in test data
Pz_q = pLSA_EMfold(Xtest,Pw_z,[],25,beta);

Learn.TEM = 0;
[Pw_z2,Pz_d2,Pd2,Li] = pLSA(Xtrain,[],k,Learn);
